...
# Enable PyTorch optimization
os.environ["TORCH_COMPILE_MODE"] = "max-autotune"  # Set to performance-oriented option
...
if __name__ == "__main__":
    ...
    uvicorn.run("bitnet:app", host="0.0.0.0", port=8000, reload=False)
